...
export declare class GrowableXYZArray extends IndexedXYZCollection {
     ...
     * @param result optional result
     */
    getVector3dBetweenIndices(pointIndexA: number, pointIndexB: number, result?: Vector3d): Vector3d | undefined;
    ...
    distanceIndexToPoint(i: number, spacePoint: Point3d): number;
